namespace eda7k.Models.MyChannel
{
    ...
    //Ольга Павловна, если вы это читаете - простите за этот код :)
    //Это моя "альтернатива" лонг пул запросов. В интеренете такого не нашел, только похожее
    //Надо рефакторить, но я не знаю как тут получше нарезать
    public static class MyChannel
    {
        ...
        public static async void Write(KeyValuePair<Operations, int> operationAndId)
        {
